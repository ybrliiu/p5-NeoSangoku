...
subtest 'get' => sub {
...

  {
    ...
    is $list->[0]{path}, "${dir_path}0.gif";
    is $list->[scalar @$list - 1]{path}, "${dir_path}49.gif";
  }

  {
    my $icon_list = $TEST_CLASS->new();
    ok(my $list = $icon_list->get(1));
    is $list->[0]{path}, "${dir_path}50.gif";
    is $list->[scalar @$list - 1]{path}, "${dir_path}99.gif";
  }
...

  {
    ...
    is $list->[0]{path}, "${dir_path}450.gif";
    is $list->[scalar @$list - 1]{path}, "${dir_path}499.gif";
  }
